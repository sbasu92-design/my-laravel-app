  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('admin/dashboard')}}" class="brand-link">
      <img src="{{asset('public/assets/dist/img/Logo.jpg')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Ecommerce Web</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.list') }}"  class="nav-link @if(Request::segment(2)=='list'|| Request::segment(2)=='addadmin' || Request::segment(2)=='editadmin'  ) active @endif">
